...
$lang = array_merge($lang, array(
	...
	'ASACP_AKISMET_POST_LIMIT_EXPLAIN'			=> 'Si l’utilisateur dispose d’un nombre de messages plus élevé que ce chiffre, la vérification Akismet ne sera pas utilisée pour cet utilisateur.<br /><strong>Si 0 est entré, la vérification Akismet fonctionne en permanence.</strong>',
	...
	'ASACP_BAN_DELETE_AVATAR_EXPLAIN'			=> 'Supprimer l’avatar de l’utilisateur lorsque « Bannir en un Clic » est activé',
	...
	'ASACP_BAN_DELETE_POSTS_EXPLAIN'			=> 'Supprimer les messages de l’utilisateur lorsque « Bannir en un Clic » est activé',
	'ASACP_BAN_DELETE_PROFILE_FIELDS'			=> 'Supprimer les champs du profil',
	'ASACP_BAN_DELETE_PROFILE_FIELDS_EXPLAIN'	=> 'Supprimer les champs du profil de l’utilisateur lorsque « Bannir en un Clic » est activé',
	...
	'ASACP_BAN_MOVE_TO_GROUP_EXPLAIN'			=> 'Déplacer l’utilisateur vers le groupe sélectionné dans la liste lorsque « Bannir en un Clic » est activé',
	'ASACP_BAN_SETTINGS'						=> 'Bannir en un Clic',
	'ASACP_BAN_USERNAME'						=> 'Bannir l’utilisateur',
	'ASACP_BAN_USERNAME_EXPLAIN'				=> 'Bannir l’utilisateur lorsque « Bannir en un Clic » est activé',
	...
	'ASACP_IP_SEARCH_FLAG_LOG'					=> 'Log des marquages utilisateurs',
	...
	'ASACP_IP_SEARCH_SPAM_LOG'					=> 'Journal de Spams',
	'ASACP_IP_SEARCH_USERS'						=> 'Utilisateurs',
	'ASACP_LOG'									=> 'Activer le Journal de Spams',
	'ASACP_LOG_EXPLAIN'							=> 'Si désactivé, les nouveaux éléments ne seront pas ajoutés à la log des spams.',
	'ASACP_NOTIFY_NEW_FLAG'						=> 'Prévenir sur nouvelle entrée dans le Journal des marquages',
	'ASACP_NOTIFY_NEW_FLAG_EXPLAIN'				=> 'Prévenir les utilisateurs autorisés lorsqu’un nouvel élément est inscrit dans la log.',
	...
	'ASACP_SFS_KEY'								=> 'Clés pour Stop Forum Spam',
	'ASACP_SFS_KEY_EXPLAIN'						=> 'Si vous voulez soumettre des informations à <a href="http://www.stopforumspam.com/">Stop Forum Spam</a>, enregistrez-vous <a href="http://www.stopforumspam.com/signup">ici</a> et entrez la clé donnée dans ce champ.',
	...
	'ASACP_SPAM_WORDS_ENABLE_EXPLAIN'			=> 'Mettre « Non » pour désactiver tout le système lié aux « Mots de Spam ».',
	'ASACP_SPAM_WORDS_EXPLAIN'					=> 'Entrer et gérer les mots pour le système de mots de spam.',
	'ASACP_SPAM_WORDS_FLAG_LIMIT'				=> 'Nombre de marquages avant de marquer comme spam',
	'ASACP_SPAM_WORDS_FLAG_LIMIT_EXPLAIN'		=> 'Si les messages sont marqués comme spam plus que ce nombre, le message sera interdit ou demandera une approbation.',
	'ASACP_SPAM_WORDS_PM_ACTION'				=> 'Action pour les spam de messages privés',
	'ASACP_SPAM_WORDS_PM_ACTION_EXPLAIN'		=> 'Sélectionner les actions à accomplir quand un message privé est marqué comme spam.',
	...
	'ASACP_SPAM_WORDS_POST_LIMIT_EXPLAIN'		=> 'Quand l’utilisateur a un nombre de messages supérieur à ce nombre, le contrôle des mots de spam ne sera pas appliqué à cet utilisateur.<br /><strong>Si à 0, le contrôle des mots de spam sera toujours actif.</strong>',
	'ASACP_SPAM_WORDS_PROFILE_ACTION'			=> 'Action pour le spam de profil',
	'ASACP_SPAM_WORDS_PROFILE_ACTION_EXPLAIN'	=> 'Sélectionner l’action à accomplir quand une information du profil d’un utilisateur est marqué comme spam.',
	...
	'DELETE_SPAM_WORD'							=> 'Supprimer les Mots de Spam',
	'DELETE_SPAM_WORD_CONFIRM'					=> 'Êtes vous sûr de vouloir supprimer les Mots de Spam ?',
	...
	'LOG_VIEW_POST'								=> '%sVoir les messages%s',
	...
	'NO_SPAM_WORDS'								=> 'Aucun Mot de Spam dans la base.',
	...
	'REGEX_AUTO_EXPLAIN'						=> 'Choisir « Oui » pour que le système crée automatiquement l’expression régulière avec le contenu dans « Texte du Mot de Spam ».',
	'REGEX_EXPLAIN'								=> 'Choisir « Oui » pour utiliser l’expression régulière saisie dans « Texte du Mot de Spam ».',
	'REQUIRE_ADMIN_ACTIVATION'					=> 'Nécessite l’activation par un administrateur',
	'REQUIRE_APPROVAL'							=> 'Nécessite l’activation par un modérateur',
	...
	'SPAM_WORD_DELETE_SUCCESS'					=> 'Mot de Spam supprimés avec succès.',
	'SPAM_WORD_EDIT_SUCCESS'					=> 'Mot de Spam édité avec succès.',
